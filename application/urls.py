...
urlpatterns = [
    ...
    # Логи посещаемости
    path(
        "attendance/aggregated/download/",
        AggregatedAttendanceDownloadView.as_view(),
        name="aggregated_attendance",
    ),
    path(
        "attendance/aggregated/",
        AggregatedAttendanceView.as_view(),
        name="aggregated_attendance",
    ),
    path(
        "attendance/",
        AttendanceRecordListCreateView.as_view(),
        name="attendance_list_create",
    ),
    path(
        "attendance/attach_file/",
        AttachFileToAttendanceView.as_view(),
        name="attach_file_to_attendance",
    ),
    # Расписание
